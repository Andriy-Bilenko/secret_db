...
let instantiate_contract = async (startingCount: number) => {
  // TODO CHANGE THE INIT MSG
  const initMsg: { count: number } = { count: startingCount };//not sure whether number or string
